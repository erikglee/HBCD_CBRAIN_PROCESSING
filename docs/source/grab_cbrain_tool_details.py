...
def generate_rst(json_data, tool_config_id, tool_name, url):
    ...
    with open(f'tools/{tool_name}.rst', 'w') as f:
        ...
        f.write('"Argument IDs" correspond to "id"s within the Boutiques Descriptors. "Value"s correspond.\n')
        f.write('to either specific configuration files if there is a numeric value, or otherwise file types\n')
